...
import img3 from './p5.jpg'
import img4 from './pl1.jpg'
import pl1 from './p8.jpg'
import pl2 from './p9.jpg'
import pl3 from './p10.jpg'
                        ...
                        <Carousel responsive={responsive} >
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <span style={{ paddingLeft: '140px' }}></span>
                                </div>
                            </div>
    ...
    <div>
        <div className='m-3 m-md-5'>
            <Container>
                <Row className='align-items-center'>
                    <Col sm={5} className='mt-3 mt-sm-0'>
                        <img src={img2} alt="" className='img-fluid h-100' style={{ width: '500px', height: '774px', flexShrink: 0 }} />
                    </Col>
                    <Col sm={7} className='mt-3 mt-sm-0'>
                        <img src={img3} alt="" className='img-fluid h-100' style={{width: '780px', height: '774px', flexshrink: 0}} />
                    </Col>
                </Row>
            </Container>
        </div>
